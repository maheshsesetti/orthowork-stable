...
/**
 * REST controller for managing {@link com.orthoworks.common.domain.Brand}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BrandResource {
    ...
    private static final String ENTITY_NAME = "commonBrand";
     ...
     */
    @GetMapping("/brands")
    public ResponseEntity<List<Brand>> getAllBrands(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
