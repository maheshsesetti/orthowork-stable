...
import com.orthoworks.api.domain.Transaction;
import com.orthoworks.api.repository.TransactionRepository;
...
/**
 * REST controller for managing {@link com.orthoworks.api.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TransactionResource {
    ...
    private static final String ENTITY_NAME = "apiTransaction";
        ...
        if ("result-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(
                StreamSupport
                    ...
                    .filter(transaction -> transaction.getResult() == null)
