...
export const TransactionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="orthoworksApp.transaction.delete.question">
        <Translate contentKey="orthoworksApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
