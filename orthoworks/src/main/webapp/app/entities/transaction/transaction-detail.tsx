    ...
    <Row>
      <Col md="8">
        <h2 data-cy="transactionDetailsHeading">
          <Translate contentKey="orthoworksApp.transaction.detail.title">Transaction</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="orthoworksApp.transaction.title">Title</Translate>
            </span>
          </dt>
          <dd>{transactionEntity.title}</dd>
          <dt>
            <span id="status">
              <Translate contentKey="orthoworksApp.transaction.status">Status</Translate>
            </span>
          </dt>
          <dd>{transactionEntity.status}</dd>
          <dt>
            <span id="date">
              <Translate contentKey="orthoworksApp.transaction.date">Date</Translate>
            </span>
          </dt>
          <dd>{transactionEntity.date ? <TextFormat value={transactionEntity.date} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <Translate contentKey="orthoworksApp.transaction.collection">Collection</Translate>
          </dt>
          <dd>{transactionEntity.collection ? transactionEntity.collection.title : ''}</dd>
        </dl>
