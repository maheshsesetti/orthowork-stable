  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="orthoworksApp.notification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="orthoworksApp.notification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('orthoworksApp.notification.date')}
              ...
              />
              <ValidatedField
                label={translate('orthoworksApp.notification.details')}
              ...
              />
              <ValidatedField
                label={translate('orthoworksApp.notification.sentDate')}
              ...
              />
              <ValidatedField
                label={translate('orthoworksApp.notification.format')}
              ...
              >
                {notificationTypeValues.map(notificationType => (
                  <option value={notificationType} key={notificationType}>
                    {translate('orthoworksApp.NotificationType.' + notificationType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('orthoworksApp.notification.userId')}
              ...
              />
              <ValidatedField
                label={translate('orthoworksApp.notification.brandId')}
