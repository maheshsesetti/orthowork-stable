...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRANDCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRANDCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRANDCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRANDCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRANDCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRANDCATEGORY actions', async () => {
      const expectedActions = [
        {
