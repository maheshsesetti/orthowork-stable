...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './collector.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLLECTOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLLECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLLECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLLECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLLECTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLLECTOR actions', async () => {
      const expectedActions = [
        {
