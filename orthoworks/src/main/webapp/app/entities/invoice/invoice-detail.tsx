    ...
    <Row>
      <Col md="8">
        <h2 data-cy="invoiceDetailsHeading">
          <Translate contentKey="orthoworksApp.invoice.detail.title">Invoice</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="code">
              <Translate contentKey="orthoworksApp.invoice.code">Code</Translate>
            </span>
          </dt>
          <dd>{invoiceEntity.code}</dd>
          <dt>
            <span id="date">
              <Translate contentKey="orthoworksApp.invoice.date">Date</Translate>
            </span>
          </dt>
          <dd>{invoiceEntity.date ? <TextFormat value={invoiceEntity.date} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="details">
              <Translate contentKey="orthoworksApp.invoice.details">Details</Translate>
            </span>
          </dt>
          <dd>{invoiceEntity.details}</dd>
          <dt>
            <span id="status">
              <Translate contentKey="orthoworksApp.invoice.status">Status</Translate>
            </span>
          </dt>
          <dd>{invoiceEntity.status}</dd>
          <dt>
            <span id="paymentMethod">
              <Translate contentKey="orthoworksApp.invoice.paymentMethod">Payment Method</Translate>
            </span>
          </dt>
          <dd>{invoiceEntity.paymentMethod}</dd>
          <dt>
            <span id="paymentDate">
              <Translate contentKey="orthoworksApp.invoice.paymentDate">Payment Date</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="paymentAmount">
              <Translate contentKey="orthoworksApp.invoice.paymentAmount">Payment Amount</Translate>
            </span>
          </dt>
