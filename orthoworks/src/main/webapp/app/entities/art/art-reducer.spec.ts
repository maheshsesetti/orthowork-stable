...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './art.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ART_LIST actions', async () => {
    ...
    it('dispatches FETCH_ART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ART actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ART actions', async () => {
      const expectedActions = [
        {
