...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './output.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OUTPUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_OUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OUTPUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OUTPUT actions', async () => {
      const expectedActions = [
        {
