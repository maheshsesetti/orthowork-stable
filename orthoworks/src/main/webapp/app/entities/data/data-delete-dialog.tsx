...
export const DataDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(dataEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="orthoworksApp.data.delete.question">
        <Translate contentKey="orthoworksApp.data.delete.question" interpolate={{ id: dataEntity.id }}>
