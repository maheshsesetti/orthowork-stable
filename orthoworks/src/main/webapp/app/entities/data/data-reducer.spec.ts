...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_DATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DATA actions', async () => {
      const expectedActions = [
        {
