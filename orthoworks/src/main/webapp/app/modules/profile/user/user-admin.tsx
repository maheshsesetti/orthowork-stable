...
import { saveAccountSettings, reset } from './user-admin.reducer';
import { RouteComponentProps } from 'react-router-dom';

export const UserAdminPage = (props: RouteComponentProps<{ name: string }>) => {
  ...
  return (props.match.params.name === account.login ?
    <div>
