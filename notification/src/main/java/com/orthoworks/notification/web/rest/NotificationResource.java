package com.orthoworks.notification.web.rest;

import com.orthoworks.notification.domain.Notification;
import com.orthoworks.notification.repository.NotificationRepository;
import com.orthoworks.notification.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.orthoworks.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
